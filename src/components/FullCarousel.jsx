...
function FullCarousel() {
  return (
    <div
      id="carousels"
      className="relative -mt-52 sm:-mt-80 overflow-hidden z-100"
    >
        ...
        <section className="mx-2 md:mx-10 sm:pb-28 bg-[#0038c7] relative  ">
          ...
          <div className="absolute inset-0  flex  justify-start items-center -mt-16 md:-mt-0 overflow-hidden  ">
            <div className="absolute top-[15%] justify-center items-center bg-[#a7ff00] text-black py-5 -rotate-[6deg] flex border-[2px] border-black w-full overflow-hidden">
              <span className="text-black font-brasika text-md sm:text-2xl md:text-5xl mr-6">
                Carousels
              </span>
              <span className="text-black font-brasika text-md sm:text-2xl md:text-5xl mr-6">
                Carousels
              ...
              <span className="hidden sm:block text-black font-brasika text-xs sm:text-2xl md:text-5xl">
                Carousels
              </span>
            </div>
          </div>
          ...
          <div className="absolute inset-0 flex  justify-center items-center -mt-[145%] sm:-mt-44 md:-mt-56 overflow-hidden">
            ...
            <Link to={"/carousels"}>
              <button className="relative flex group z-50  mt-[700px] sm:mt-[700px] px-12 py-2 border-[2px] border-[#a7ff00] rounded-3xl bg-white text-black  items-center justify-center space-x-2 transform transition-all duration-200 hover:scale-105 hover:bg-black hover:text-[#a7ff00]">
