      ...
      <div className="container mx-auto flex justify-between gap-2 items-start">
        ...
        <div className="flex space-x-10">
          <div className="flex gap-7 sm:gap-20 px-3 sm:px-10">
            <div>
              <h4 className="font-bold text-[#a7ff00] text-sm sm:text-lg">About Us</h4>
              <ul className="mt-2 text-[10px] sm:text-sm space-y-1">
              <li className="hover:text-[#a7ff00]">
              <a href="#home">Home</a>
                </li>
                <li className="hover:text-[#a7ff00]">
            ...
            <div>
              <h4 className="font-bold text-[#a7ff00] text-sm sm:text-lg">All Works</h4>
              <ul className="mt-2 text-[10px] sm:text-sm space-y-1">
                <li className="hover:text-[#a7ff00]">
