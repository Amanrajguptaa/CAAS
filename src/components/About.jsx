        ...
        <section className="mx-2 md:mx-10 min-h-[600px] sm:min-h-[900px] bg-[#0038c7] relative ">
          ...
          <div className="absolute inset-0 top-5 sm:top-20 flex flex-col justify-start  items-center text-black ">
            ...
            <div className="relative ml-28 sm:ml-32 mt-5 pb-0 sm:pb-10">
                ...
                <div className="relative z-40"><img className="-ml-[6px] sm:-ml-0 w-4/6 sm:w-5/6" src="/statue2.png" alt="" /></div>
                ...
                <div className="absolute bg-lime-500 rounded-xl border-[2px] border-black h-20 w-32 sm:h-40 sm:w-60 top-[200px] sm:top-[400px] -left-20 sm:-left-40 text-xs sm:text-2xl p-2 flex flex-col justify-center ">that too at <span className="text-white">a non- <br /> competitive  price</span></div>
            </div>
            <Footer/>
          </div>
        </section>
